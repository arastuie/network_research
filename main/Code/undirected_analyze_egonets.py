...
# run_parallel_local_degree_distribution_gathering(fb.empirical_pickle_base_path + 'local-degree-dist/pickle-files-1/', 6)
...
#                                   fb.empirical_pickle_base_path + 'local-degree-dist/plots/', gather_individual_results=True)
