...
analyzed_egonets = set(os.listdir(fb.empirical_pickle_path + 'analyzed_egonets'))
...
Parallel(n_jobs=6)(delayed(fb.run_local_degree_empirical_analysis)(ego_net_file) for ego_net_file in egonets_to_analyze)
