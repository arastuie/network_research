...
# Parallel(n_jobs=15)(delayed(analyzer.gplus_run_hop_degree_directed_analysis)(ego_net_file)
#                     for ego_net_file in os.listdir(data_file_base_path))

top_k_values = [1, 3, 5, 10, 15, 20, 25, 30]
Parallel(n_jobs=26)(delayed(dh.run_link_prediction_comparison_on_directed_graph_all_types)(ego_net_file, top_k_values)
                    for ego_net_file in os.listdir(data_file_base_path))
