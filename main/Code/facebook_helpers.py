...
def run_local_degree_empirical_analysis(ego_net_file):
    ...
    if os.path.isfile(empirical_pickle_path + 'analyzed_egonets/' + ego_net_file):
        return
    ...
    if len(snapshots_local_formed) > 0:
        with open(empirical_pickle_path + 'results/' + ego_net_file, 'wb') as f:
    ...
    with open(empirical_pickle_path + 'analyzed_egonets/' + ego_net_file, 'wb') as f:
